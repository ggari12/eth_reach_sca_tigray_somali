...
df_cleaning_log <- read_csv("inputs/combined_checks_eth_sca_tigray_somali_GG.csv", col_types = cols(sheet = "c", index = "i")) |> 
  filter(reviewed %in% c("1"))

# raw data
loc_data <- "inputs/ETH2306a_SCA_Tigray_Somali_data.xlsx"
...
# import clean data
clean_data_path <- "inputs/clean_data_eth_sca_tigray_somali.xlsx"
...
openxlsx::write.xlsx(x = list(Summary = df_variable_summary,
                     ...
                     file = paste0("outputs/", butteR::date_file_prefix(), "_eth_sca_data_cleaning_logbook_for_formatting.xlsx"))
...
#  "i.hhs_cat",   "Added",                                                                                                                 "Computed based on i.hhs (thresholds 1, 3, 6)",
  ...
  "ki_phone_no", "Removed",                                                                                                                "Blanked columns related to the survey and PII",
...
saveWorkbook(wb_log, paste0("outputs/", butteR::date_file_prefix(),"_eth_sca_data_cleaning_logbook.xlsx"), overwrite = TRUE)
openXL(file = paste0("outputs/", butteR::date_file_prefix(),"_eth_sca_data_cleaning_logbook.xlsx"))
